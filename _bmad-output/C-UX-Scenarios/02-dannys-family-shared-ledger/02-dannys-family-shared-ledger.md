...
开通付费后邀请小芳加入共享家庭账本，让夫妻看到同一份消费数据。

---

## Business Goal (Q2)

**Goal:** GROWTH（留存 >= 40%）+ SUSTAINABILITY（付费转化 >= 5%）
**Objective:** 2.2 30日留存率 >= 40%, 3.1 付费转化率 >= 5%
...
|------|--------|---------|-------------|
| 02.1 | `02.1-subscription/` | 查看付费方案并订阅 | 完成支付 |
